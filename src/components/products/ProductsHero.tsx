...
export function ProductsHero() {
  ...
  return (
    ...
    >
      {/* Background Image with Masking (Same as Use Cases Hero) */}
      <div className="absolute inset-0 z-0">
        <Image
          src={SITE_DATA.heroBg}
          alt="Zyene AI Products — hero background"
          fill
          priority
      ...
      >
        ...
        <div className="max-w-[400px] pb-4">
          ...
          >
            Zyene Reviews and Zentraic AI help you automate follow-up, protect your reputation, qualify leads, and keep CRM data in sync. We solve the problems businesses face when they do not have enough time to solve them internally.
          </motion.p>
        </div>
      </motion.div>
    </section>
