...
export function BlogHero() {
  ...
  const headingLines = ["Ideas that", "scale with you."]
    ...
    >
      ...
      >
        ...
        <div className="max-w-[400px] pb-4">
          ...
          >
            Practical notes on AI execution, operations, and growth — how teams ship reliable systems,
            protect reputation, and scale without losing clarity.
          </motion.p>
        </div>
      </motion.div>
    </section>
